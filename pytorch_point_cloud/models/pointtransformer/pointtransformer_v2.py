...
from .pointtransformer_utils import load_pointtransformer_v2_pretrained
...
class Network(nn.Module):
    def __init__(self, config):
        ...
        self.encoder_depths = list(pt_cfg.depth)
        ...
        self.pretrained_load_info = load_pointtransformer_v2_pretrained(self, config)
